...
- Task results: paginação CDF em lotes de 250 (`ANALYTICS_TASK_RESULT_PAGE_SIZE`), todas as páginas até `nextCursor` acabar (`ANALYTICS_TASK_RESULT_MAX_PAGES = undefined`). Filtro de período só no cliente.
